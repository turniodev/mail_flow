...
const PurchasesTab: React.FC = () => {
  ...
  const getJsSnippet = (evtId: string) => `// API Tracking Mua hàng
const trackPurchase = async () => {
    const payload = {
        ...
        // Thông tin đơn hàng (Khuyên dùng)
        total_value: 1500000,
        currency: "VND",
        items: [
        ...
        // Cập nhật thông tin khách (Tùy chọn)
        firstName: "Nguyen",
        lastName: "Van A",
  ...
  return (
    <div className="space-y-6 pb-40">
      <div className="flex justify-between items-center bg-white p-4 rounded-2xl border border-slate-200 shadow-sm">
          <div>
              <h3 className="text-lg font-bold text-slate-800">Sự kiện Mua hàng</h3>
              <p className="text-xs text-slate-500 font-medium">Định nghĩa sự kiện để API ghi nhận đơn hàng.</p>
          </div>
        ...
        {loading ? (
           <div className="col-span-full space-y-4">
            ...
            <div className="col-span-full py-20 text-center border-2 border-dashed border-slate-200 rounded-[40px] bg-slate-50/50">
                ...
                <p className="text-slate-400 mt-2 text-sm">Tạo sự kiện để API có thể gửi dữ liệu đơn hàng về hệ thống.</p>
      ...
      >
          <div className="space-y-4 py-2">
              <Input 
                ...
                placeholder="VD: Mua gói Premium..." 
                value={eventName} 
